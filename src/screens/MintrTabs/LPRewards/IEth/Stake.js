...
const Stake = ({ walletDetails, goBack }) => {
	...
	const fetchData = useCallback(async () => {
		...
		try {
			...
			const [iETHBalance, iETHStaked, rewards] = await Promise.all([
			...
			<ButtonBlock>
				...
				<ButtonRow>
					...
					<ButtonAction
						...
						disabled={!balances || (!balances.iETHStaked && !balances.rewards)}
						onClick={() =>
							setCurrentScenario({
								action: 'exit',
