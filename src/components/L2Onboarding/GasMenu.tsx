...
import { setCurrentGasPrice, getNetworkPrices } from '../../ducks/network';
...
const GasMenu = ({ networkPrices, setCurrentGasPrice, setSelectedSpeed }) => {
						...
						<List>
							...
							{networkPrices && networkPrices.SLOW ? (
								<>
									<HoverListElement
										onClick={() => {
											setSelectedSpeed(NETWORK_SPEEDS_TO_KEY.SLOW);
									...
									<HoverListElement
										onClick={() => {
											setSelectedSpeed(NETWORK_SPEEDS_TO_KEY.AVERAGE);
									...
									<HoverListElement
										onClick={() => {
											setSelectedSpeed(NETWORK_SPEEDS_TO_KEY.FAST);
