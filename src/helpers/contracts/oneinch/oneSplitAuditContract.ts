...
export default {
	...
	abi: [
		{
			inputs: [{ internalType: 'contract IOneSplitMulti', name: 'impl', type: 'address' }],
			payable: false,
		...
		{
			anonymous: false,
			inputs: [{ indexed: true, internalType: 'address', name: 'newImpl', type: 'address' }],
		...
		},
		{
			...
			inputs: [],
			name: 'oneSplitImpl',
			outputs: [{ internalType: 'contract IOneSplitMulti', name: '', type: 'address' }],
			payable: false,
			stateMutability: 'view',
			type: 'function',
		},
